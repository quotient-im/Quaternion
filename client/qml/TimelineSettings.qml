...
Settings {
    ...
    readonly property real font_pointSize_impl: parseFloat(value("UI/Fonts/timeline_pointSize", ""))
    readonly property var defaultMetrics: FontMetrics { }
    readonly property var fontInfo: FontMetrics {
        font.family: font_family_impl ? font_family_impl : defaultMetrics.font.family
        font.pointSize: font_pointSize_impl > 0 ? font_pointSize_impl : defaultMetrics.font.pointSize
    }
    ...
    readonly property real minimalTimelineItemHeight: lineSpacing * (2 - timelineStyleIsXChat)

    readonly property var render_type_impl: value("UI/Fonts/render_type", "native")
    ...
    {
        return Qt.tint(baseColor, Qt.rgba(mixedColor.r, mixedColor.g, mixedColor.b, mixRatio))
    }
    ...
    readonly property color lowlight_color: mixColors(disabledPalette.text, palette.text, 0.3)
